  ...
  return (
    <div className="max-w-6xl mx-auto" data-testid="opportunity-details-page">
      ...
      <div className="flex items-center gap-2 text-xs text-slate-500 mb-8 overflow-x-auto whitespace-nowrap pb-2">
        <Link to="/dashboard" className="hover:text-emerald-700 transition-colors">Home</Link>
        <ChevronRight size={12} />
        <Link to="/explorer" className="hover:text-emerald-700 transition-colors">Explorer</Link>
        <ChevronRight size={12} />
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        ...
        <div className="flex gap-3 shrink-0">
          ...
          <Button onClick={toggleSave} disabled={busy} variant={isSaved ? "default" : "outline"} className={`h-11 ${isSaved ? "bg-emerald-700 hover:bg-emerald-800" : "border-slate-300"}`}>
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm group hover:border-slate-300 transition-colors">
      <div className="flex items-center justify-between mb-6">
        ...
        {aiAction && (
          <Button variant="ghost" size="sm" className="text-xs font-bold text-emerald-700 hover:bg-emerald-50 rounded-lg">
