...
export default function Drafts() {
  ...
  return (
    <div className="max-w-5xl" data-testid="drafts-page">
      <div className="mb-10">
        <div className="text-[10px] uppercase tracking-[0.22em] text-emerald-700 font-bold">AI-assisted writing</div>
                ...
                <div className="flex items-start justify-between gap-6 flex-wrap">
                  ...
                  <div className="w-full md:w-72">
                    ...
                    <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden">
                      <motion.div initial={{ width: 0 }} animate={{ width: `${d.progress}%` }} transition={{ duration: 1, delay: 0.2 }} className="h-full bg-emerald-700" />
                    </div>
                  </div>
                </div>
