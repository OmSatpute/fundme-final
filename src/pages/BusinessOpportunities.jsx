...
const BENEFITS = ["Government procurement opportunity", "Pilot Contract", "Mentorship", "Access to Infrastructure", "Paid Trial"];
  ...
  return (
    <div className="flex gap-8" data-testid="business-page">
      ...
      <section className="flex-1 min-w-0">
        <div className="mb-6">
          <div className="text-[10px] uppercase tracking-[0.22em] text-[var(--accent)] font-bold">Beyond grants</div>
